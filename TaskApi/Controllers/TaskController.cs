...
public class TasksController : ControllerBase {
    private static List<TaskItem> _tasks = new() {
        new TaskItem { Id = 1, Title = "изучить ASP.NET Core", Priority = "High", IsCompleted = true },
        new TaskItem { Id = 2, Title = "сделать лабораторную №28", Priority = "High", IsCompleted = false },
        new TaskItem { Id = 3, Title = "написать README", Priority = "Normal", IsCompleted = false },
    };
